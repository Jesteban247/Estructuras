...
template <class T>
bool ArbolAVL<T>::buscarRecursivo(const NodoAVL<T>* nodo, const T& val) const
{
    if (nodo == nullptr) {
        return false;
    }
...
template <class T>
int ArbolAVL<T>::calcularTamano(NodoAVL<T>* nodo) const
{
    if (nodo == nullptr) {
        return 0;
    }
    return 1 + calcularTamano(nodo->obtenerHijoIzq()) + calcularTamano(nodo->obtenerHijoDer());
}

template <class T>
void ArbolAVL<T>::preOrdenRecursivo(const NodoAVL<T>* nodo) const
{
    if (nodo == nullptr) {
        return;
    }
...
template <class T>
void ArbolAVL<T>::inOrdenRecursivo(const NodoAVL<T>* nodo) const
{
    if (nodo == nullptr) {
        return;
    }
...
template <class T>
void ArbolAVL<T>::posOrdenRecursivo(const NodoAVL<T>* nodo) const
{
    if (nodo == nullptr) {
        return;
    }
...
template <class T>
int ArbolAVL<T>::calcularAltura(NodoAVL<T>* nodo) {
    if (nodo == nullptr) {
