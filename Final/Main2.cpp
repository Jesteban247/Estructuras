...
int main(){
            ...
            for (int i = 0; i < cantidadJugadores; i++)
            {
                ...
                jugadores.push_back(jugador);
                              ...
                              for (Jugador &jugador : jugadores) {
                                  ...
                                  cout << jugador.getNombre() << " tuvo " << random_number << endl;
                                  jugador.setDado(random_number);
                              }


                              // Ordenar jugadores por el resultado del dado (en orden descendente)
                              sort(jugadores.begin(), jugadores.end(), [](Jugador &a, Jugador &b) {
                                  return a.getDado() > b.getDado();
                              });
                              ...
                              for (Jugador &jugador : jugadores) {
                                  ...
                                  cout << "Nombre: " << jugador.getNombre() << ", Turno: " << jugador.getTurno() << endl; 
                              }
          ...
          if (tokens.size() == 2) {
               if (jugadores.empty()) {
                        cout << "No hay jugadores registrados." << std::endl;
                            } else {
          ...
          cout << "Comando 'turno' incompleto. Debe proporcionar un "
                  "<id_jugador>."
               << endl;
        }
      }
        ...
        if (tokens.size() == 2) {
          ...
          cout << "Comando 'guardar' incompleto. Debe proporcionar un archivo."
               << endl;
        }
      }
        else if (tokens[0] == "cargar_txt") {
        ...
        else if (tokens[0] == "cargar_comprimido") {
      ...
      // Componente 3: estrategias de juego
        ...
        if (tokens.size() == 2) {
          ...
          cout << "Comando 'costo_conquista' ingresado para:" << territorio
               << endl;
        } else {
          cout << "Comando 'costo_conquista' incompleto. Debe proporcionar un "
                  "territorio."
               << endl;
        }
      }
        ...
        if (tokens.size() > 1) {
          cout << "El comando 'conquista_mas_barata' no debe tener argumentos "
                  "adicionales."
               << endl;
        } else {
      ...
      // Ayuda
        ...
        if (tokens.size() > 3) {
          cout << "El comando 'ayuda' no debe tener argumentos adicionales."
               << endl;
        } else {
          if (tokens.size() == 1) {
            menu_ayuda();
          ...
          if (tokens.size() > 1) {
            cout << "El comando 'salir' no debe tener argumentos adicionales."
                 << endl;
          } else {
